...
Thanks for your interest in contributing to `mirror-template`
...
* If you think you have found a bug, or have a new feature idea, please start by making sure it hasn't already been [reported](https://github.com/lunaris-studios/mirror-template/issues). You can search through existing issues to see if there is a similar one reported. Include closed issues as it may have been closed with a solution.

* Next, [create a new issue](https://github.com/lunaris-studios/mirror-template/issues/new/choose) that thoroughly explains the problem. Please fill out the populated issue form before submitting the issue.
...
* Create a new project via the [**Mirror CLI Tool**](https://github.com/lunaris-studios/mirror), using the `mirror-template` template. 
...
* Looking for an issue to fix? Make sure to look through our issues with the [help wanted](https://github.com/lunaris-studios/mirror-template/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) label!
...
1. [Create a new pull request](https://github.com/lunaris-studios/mirror-template/compare) with the `master` branch as the `base`. You may need to click on `compare across forks` to find your changes.
